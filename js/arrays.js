...
//! 4 Reduce
//! Recibe dos argumentos, un callback, fun y un  initialValue (default a 0)
    //! su callback recibe 4 parametros predefinidos
    //! Total o Previous Value o accumulador, Cv, Index, Copia Array

    let arr = [1,2,3,4,5,6]

    const cbFun = (accumulador, cv) => {
        accumulador += cv
        return accumulador
    }
