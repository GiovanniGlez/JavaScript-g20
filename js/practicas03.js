//Practica 1
/*let number1 = parseInt(prompt('Proporciona un número'));
let number2 = parseInt(prompt('Proporciona otro número'));
let number3 = parseInt(prompt('Proporciona el último número'));
let max = 0;
...
console.log(maxNumber, "es el numero mayor");*/
